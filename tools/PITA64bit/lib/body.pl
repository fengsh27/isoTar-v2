...
require "/opt/PITA64bit/lib/libfile.pl";
...
while(@ARGV)
{
  ...
  {
    die("/home/BioinformaticsTools/miRNATargetPrectorsTools/PITA64bit/lib/body.pl: Bad argument '$arg' given.  Use --help for help.");
  }
}
...
{
   $tmp_file = 'tmp_' . time . '.' . rand() . './home/BioinformaticsTools/miRNATargetPrectorsTools/PITA64bit/lib/body.pl';
...
__DATA__
Syntax: /home/BioinformaticsTools/miRNATargetPrectorsTools/PITA64bit/lib/body.pl BEG END < FILE
...
-f:               Allow giving BEG and END as fractions of number of lines in file (for example /home/BioinformaticsTools/miRNATargetPrectorsTools/PITA64bit/lib/body.pl 4 -0.2)
