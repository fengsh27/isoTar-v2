...
require "/opt/PITA64bit/lib/sequence_helpers.pl";
require "/opt/PITA64bit/lib/format_number.pl";

my $RNAHYBRID_EXE_DIR = "/opt/RNAHybrid/src";
#my $RNAHYBRID_EXE_DIR = "/home/BioinformaticsTools/miRNATargetPrectorsTools/PITA64bit/Bin/RNAHybrid/RNAhybrid-2.1/src";
my $RNAddG_EXE_DIR    = "/opt/PITA64bit/Bin/ViennaRNA/ViennaRNA-1.6/Progs";
...
/opt/PITA64bit/lib/RNAddG_compute.pl <file>
