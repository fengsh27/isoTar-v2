...
Note: To use mouse as the reference species, change $REF_SPECIES in targetscan_70_context_scores.pl (line 155) to 10090 (instead of 9606).
So for human, line 115 should be $REF_SPECIES = 9606; whereas for mouse, line 115 should be $REF_SPECIES = 10090;
